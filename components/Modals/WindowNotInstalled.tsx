...
function WindowNotInstalled() {
  return (
    <div className="absolute z-[9999] top-4 right-[12%] flex flex-col w-80 bg-gray-900 rounded-lg px-8 py-4 justify-center items-center shadow-xl shadow-gray-400">
        ...
        }} className="flex flex-row bg-transparent px-4 py-2 mt-4 rounded-xl border-[1px] border-slate-100 border-opacity-60 hover:border-opacity-100 text-lg text-white font-thin transition-all">
            Get Window.AI
        </button>
